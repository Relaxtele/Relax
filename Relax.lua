...
if text == (database:get(bot_id.."Relax:Name:Bot") or "كيان") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Relax:Name:Bot") or "كيان")
local namebot = {
...
os.execute('wget https://raw.githubusercontent.com/KainSource/Relax/master/Relax.lua')
os.execute('wget https://raw.githubusercontent.com/KainSource/Relax/master/start.lua')
dofile('Relax.lua')  
return false
end
...
local Name_Bot = (database:get(bot_id.."Relax:Name:Bot") or "كيان")
