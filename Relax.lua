...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,370987883,370987883}
...
if hash or Bot(msg) or DevRelax(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevRelax(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevRelax(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevRelax(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevRelax(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Relax:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevRelax(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
...
if hash or Bot(msg) or  DevRelax(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
var = true
elseif DevRelax(user_id) == true then
var = true
...
elseif database:sismember(bot_id.."Relax:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."Relax:Special:User"..chat_id, user_id) then  
...
local UserName = (data.username_ or "PPPP3P")
local NameUser = "[- RELAX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/PPPP3P)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- RELAX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/PPPP3P)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
function Relax_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local Relax_Msg = database:sismember(bot_id.."Relax:List:Filter:text"..msg.chat_id_,text) 
if Relax_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."Relax:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."Relax:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."Relax:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
database:set(bot_id.."Relax:Lock:Xn"..msg.chat_id_,"del")  
...
database:del(bot_id.."Relax:Lock:Xn"..msg.chat_id_)  
...
if text == ("الثانويين") and DevRelax(msg) then
...
send(msg.chat_id_, msg.id_,"[- RELAX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/PPPP3P)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "PPPP3P")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if Relaxrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- RELAX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/PPPP3P)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "PPPP3P")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Relax:Special:User"..msg.chat_id_,result.id_)  
...
database:set(bot_id.."Relax:Filter:msg",msg.chat_id_)
...
local listtext = database:smembers(bot_id.."Relax:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."Relax:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."Relax:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."Relax:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."Relax:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."Relax:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."Relax:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."Relax:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:sadd(bot_id.."Relax:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Relax:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Relax:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Relax:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Relax:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Relax:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Relax:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."Relax:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Relax:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
local UserName = (b.username_ or "PPPP3P")
...
Srrt = https.request('https://RELAX -source.tk/RELAX TeAM/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if DevRelax(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Relax/files_Relax/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Relax/files_Relax/master/files_Relax/"..file)
if res == 200 then
...
local url,res = https.request('https://RELAX -source.tk/RELAX TeAM/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌔︙شترك في قناة السورس اولآ @PPPP3P .')   
return false 
end
Text = [[
*- RELAX  Team .*
...
[⌔︙ RELAX  𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/PPPP3P)
     
[⌔︙ ToolS RELAX  .](https://t.me/joinchat/AAAAAFPp_oZNV4U3n91zRQ)
     
[⌔︙ 𝖳WSL Source RELAX  .](http://t.me/TwSLRELAX Bot)
...
Sf = database:get(bot_id.."Relax:Filter:msg")
local list = database:smembers(bot_id.."Relax:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Relax:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."Relax:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Relax:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevRelax(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Relax:Filter"..msg.sender_user_id_) then
...
inline = {
{{text = '⌔︙ RELAX  𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/PPPP3P'}},
}
